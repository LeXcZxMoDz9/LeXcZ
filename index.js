...
ryoroyko.setStatus = (status) => {
   ...
   ryoroyko.ev.on('connection.update', async (update) => {
    ...
    say(`Create By ~_*Ļ̸͖̻͓͇͙̖͒͆̿̀͒̅̚̕è̴̲̞̫͕̜̼̩͓̪̬̳̽̃̾͋̈͂̃͋̿̀̄͝͝X̸͍͖̬͛̿̈́̚ͅc̵̢̣̱̺̘͖̑̅Ẕ̸̪͈͉͓̼̤̞̗̪̊̑́̽͆͠͝x̷̗̩̳̭̦̬̲̭̾̈̈́̓́́́͑́͛̀̓̑͝ͅM̸̨̖̳̠͚̼͓͚̗̮͓̦̄̄̇͜ȍ̷̙̩̣̑́͘D̵̢͍̩̲̤̼͕̞̥̝̳̏́͠z̶͖̪͕͖͙̹͌͒͗͂̐̃*_~`, {
    font: 'console',
    align: 'center',
    gradient: [randomcolor, randomcolor]
    })
...
await sleep(30000)
ryoroyko.sendMessage(`6287743212449@s.whatsapp.net`, { text: `❗?.`})
            }
